...
```
> If your uncle later wants "Price on request" for some items (flagged as an open question in DATABASE.md), omit the `offers` block for those products rather than sending a fake price.
